...
public class Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jsalvar1 = new javax.swing.JButton();
        ...
        jsalvar1.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        jsalvar1.setText("Consultar");
        jsalvar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jsalvar1ActionPerformed(evt);
            }
        });
    ...
    private void jsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jsalvarActionPerformed
        try{
            ...
            String identidade=jidentidade.getText();
            String nome=jnome.getText();
            String telefone=jtelefone.getText();
            String email=jemail.getText();
            sql.executeUpdate("insert into cliente(cpf,identidade,nome,telefone,email) values ('"+cpf+"','"+identidade+"','"+nome+"','"+telefone+"','"+email+"')");
    ...
    private void jsalvar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jsalvar1ActionPerformed
        ...
        try{
            ...
            Statement sql=conexao.createStatement();
            String cpf=jcpf.getText();
            sql.executeQuery("select * from cliente where cpf='"+cpf+"'");
            ResutSet linha=sql.executeQuery("select * from cliente where cpf='"+cpf+"'");
    ...
    }//GEN-LAST:event_jsalvar1ActionPerformed
    ...
    private javax.swing.JButton jsalvar1;
