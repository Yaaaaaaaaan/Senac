...
--
-- Host: localhost
-- Generation Time: 10-Jul-2017 às 10:31
...
INSERT INTO `ajuda` (`ID_comentario`, `ID_usuarioFK`, `mensagem`, `nickmsg`) VALUES
(1, NULL, 'ddsfdsvsdf', 'mec');
...
INSERT INTO `matricula` (`MAT_aluno`, `datacad`, `COD_turmaFK`, `ID_alunoFK`) VALUES
(1, '2013-05-21', 1, 3),
(2, '1988-05-21', 1, 2);
...
(22, 'fgvfdbvdfvfb', '123456', 'fuga dos morcego', 25010090, 12352322);
...
INSERT INTO `turma` (`COD_turma`, `nome_turma`, `curso`, `ano`, `status`) VALUES
(1, 'ALFA', 'JAVA', '2016', '');
...
--
ALTER TABLE `matricula`
  MODIFY `MAT_aluno` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `professor`
--
ALTER TABLE `professor`
  MODIFY `COD_professor` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `turma`
--
ALTER TABLE `turma`
  MODIFY `COD_turma` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `disciplina`
ADD CONSTRAINT `disciplina_ibfk_1` FOREIGN KEY (`COD_professorFK`) REFERENCES `professor` (`COD_professorFK`),
	ADD CONSTRAINT `disciplina_ibfk_2` FOREIGN KEY (`COD_turmaFK`) REFERENCES `turma` (`COD_turmaFK`);
--
