...
--
-- Host: localhost
-- Generation Time: 08-Jul-2017 às 08:16
...
INSERT INTO `ajuda` (`ID_comentario`, `mensagem`, `ID_usuarioFK`, `nickmsg`, `mec`) VALUES
(20, 'dxfvfdcbvcb\r\nds\r\nvd\r\nfg\r\nvds\r\nfv\r\nd\r\nc\r\nv\r\ndcvf\r\nf\r\nc\r\nv\r\nf\r\nc\r\nv\r\nfc\r\nv\r\n\r\nfc\r\nv\r\nf\r\nc\r\nxv\r\nc\r\nx\r\nv\r\nxdc\r\nv\r\ncx', 3, 'mario', 1),
(21, 'dsdfcdcv', 3, 'mario', 1),
(22, 'asdhgsjgfvhcdsvf\r\ns\r\nfdcds\r\nfvc\r\ndx\r\nvd\r\ns\r\nfv\r\ndf\r\ncv\r\nd\r\ncv', 2, 'mec', 1),
(23, 'asdhgsjgfvhcdsvf\r\ns\r\nfdcds\r\nfvc\r\ndx\r\nvd\r\ns\r\nfv\r\ndf\r\ncv\r\nd\r\ncv', 2, 'mec', 1),
(24, 'sdsadfcdxfcds', 4, 'a', 1),
(25, 'sdsadfcdxfcds', 4, 'a', 1),
(26, 'sdsadfcdxfcds', 4, 'a', 1),
(27, 'sdsadfcdxfcds', 4, 'a', 1);
...
--
ALTER TABLE `ajuda`
  MODIFY `ID_comentario` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `matricula`
  MODIFY `MAT_aluno` smallint(6) NOT NULL AUTO_INCREMENT;
--
