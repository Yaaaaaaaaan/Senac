...
<link rel="stylesheet" href="font-awesome/css/font-awesome.min.css">
	...
	<?php
		...
		if(isset($_POST["exibirprofessores"])){	
		...
		if(isset($_POST["exibirfuncionarios"])){	
										...
										<div class="row">
											<div class="col-md-10">
												<div class="coisinha" style="padding-left:50px;padding-right:10px; padding-top:10px; padding-bottom:10px">
													...
													<hr>
													<a href="#uac"><i class="fa fa-users" aria-hidden="true"></i> Usuários</a><br>
												</div>
											</div>
												...
												<form>
													<?php
														...
														$sqlc =(mysqli_query($conecta,"SELECT * FROM aluno ORDER BY ID_aluno desc"));
															...
															?>
															<div class="well" style="background:RGBA(255, 255, 255, 0.1) ;padding-bottom:50px;">
															<p><label style="color:RGBA(245,245,245,1.0)"><i class="fa fa-info" aria-hidden="true"></i> ID do aluno</label>
															<input class="form-control" type="text" readonly="true" style="color:black" value="<?php echo $alunos['ID_aluno']; ?>"> </input></p>
															
															<p><label style="color:RGBA(245,245,245,1.0)"><i class="fa fa-info" aria-hidden="true"></i> Nome do aluno</label>
							...
							<div style="position:relative;">
								<div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
									<div class="row"><div class="col-md-2"></div>
										<div 0class="col-md-8">
											<div class="well">
												<form name="teste" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="color:black;">
													<!-- Exibe Usuários cadastrados(código PHP)-->
