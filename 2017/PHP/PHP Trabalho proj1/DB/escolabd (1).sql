...
ALTER TABLE `disciplina`
ADD CONSTRAINT `disciplina_ibfk_1` FOREIGN KEY (`COD_professorFK`) REFERENCES `professor` (`COD_professor`),
	ADD CONSTRAINT `disciplina_ibfk_2` FOREIGN KEY (`COD_turmaFK`) REFERENCES `turma` (`COD_turma`);
--
