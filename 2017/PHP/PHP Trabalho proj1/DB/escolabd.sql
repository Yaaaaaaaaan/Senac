...
--
-- Host: localhost
-- Generation Time: 02-Jul-2017 às 07:03
...
ALTER TABLE `professor`
  ...
  ADD UNIQUE KEY `cpf` (`cpf_professor`),
  ADD UNIQUE KEY `cod_licenciatura` (`cod_lic`);
...
--
ALTER TABLE `professor`
  MODIFY `COD_professor` smallint(6) NOT NULL AUTO_INCREMENT;
--
