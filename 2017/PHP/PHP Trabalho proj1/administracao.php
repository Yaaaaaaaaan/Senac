...
<link rel="stylesheet" href="font-awesome/css/font-awesome.min.css">
	...
	<?php
		...
		$resultado_cadp=mysqli_query($conecta,"insert into professor (nome_professor,telefone_professor,cod_lic,residencia,cpf_professor) values ('$nomep','$telefonep','$codp','$cpfp','$residenciap')") or die(mysqli_error());
		if($resultado_cadp){
			$_SESSION["nome_professor"]=$nomep;
			$_SESSION["telefone_professor"]=$telefonep;
			$_SESSION["cod_lic"]=$codip;
			$_SESSION["residencia"]=$residenciap;
			$_SESSION["cpf_professor"]=$cpfp;
		...
		/* INSERIR DADOS AQUI O.o */
		
		
										// Pedido ajuda (Mensagem)
		if (isset($_POST["sendmsg"])){
		$nicksg=$_POST['nicksg'];
		$msg=$_POST['msg'];                     
		$comentarios=mysqli_query($conecta,"insert into ajuda (mensagem,nickmsg) values ('$msg','$nicksg')");			
		}
								...
								<li role="presentation">
									<a href="#">
											<?php
												...
												if(isset($_SESSION['usuario']))	
													echo "<i class='fa fa-briefcase' aria-hidden='true'></i> Bem vindo, ".$_SESSION['usuario'];
										...
										<div class="row">
											<div class="col-md-10">
												<div class="coisinha" style="padding-left:50px;padding-right:10px; padding-top:10px; padding-bottom:10px">
													<a href="#alm"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Alunos</a><br>
													<a href="#pgm"><i class="fa fa-file-text-o" aria-hidden="true"></i> Finanças (BREVE)</a>
													<hr>
													
													<a href="#prm"><i class="fa fa-coffee" aria-hidden="true"></i> Professores</a><br>
													<a href="#fum"><i class="fa fa-briefcase" aria-hidden="true"></i> Funcionários</a>
													<hr>
													<a href="#uac"><i class="fa fa-users" aria-hidden="true"></i> Turmas</a>
						...
						<div role="tabpanel" class="tab-pane" id="adicionar">
							...
							<div id="menu-vertical">
										...
										<div class="row">
											<div class="col-md-10">
												<div class="coisinha" style="padding-left:50px;padding-right:10px; padding-top:10px; padding-bottom:10px">
													...
													<hr>
													<a href="#adturma"><i class="fa fa-users" aria-hidden="true"></i> Turmas</a><br>
												</div>
											</div>
								...
								<div class="row">
											...
											<div class="row"><div class="col-md-2"></div>
												<div 0class="col-md-8">
													<div class="well">
														...
														<p><label for="CPF">CPF</label><input class="form-control" type="text" placeholder="Insira o CPF aqui." name="cpfa"></input></p>
											...
											<div class="row"><div class="col-md-2"></div>
												<div 0class="col-md-8">
													<div class="well">
														...
														<p><label for="licenciatura">Licenciatura</label><input class="form-control" type="text" placeholder="Insira o número de licenciatura aqui." name="codp"></input></p>
														<p><label for="cpf">CPF</label><input class="form-control" type="text" placeholder="Insira o CPF aqui." name="cpfp"></input></p>
									...
									<div class="bgimg-1" id="adturma">
										<div class="caption">
											<span class="border" style="background-color:transparent;font-size:25px;color: #f7f7f7;text-shadow: 2px 2px 8px #000000;"><i class="fa fa-plus fa-2x" style="color:#f7f7f7;text-shadow: 2px 2px 8px #000000;" aria-hidden="true"></i> Turmas</span>
										</div>
									</div>
													...
													<div class="well">
														<form name="teste" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
															<!-- Exibe relatório pedido (código PHP)-->
																		...
																		<p><button type="button submit" name="cadt" class="btn btn-success pull-right" style="margin-left: 5px;"><i class="fa fa-users" aria-hidden="true"></i> acrescentar</button></p>
