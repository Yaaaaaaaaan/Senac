	...
	<body>
		<nav class="navbar navbar-default navbar-fixed-top">
		  ...
		  <li role="presentation" class="dropdown">
			...
			<li><a href="#adicionar" aria-controls="adicionar" role="tab" data-toggle="tab"><i class="fa fa-user-plus" aria-hidden="true"></i> Adicionar</a></li>
								...
								<div id="menu">
									<div id="lateral"> 
										<div class="row">
											<div class="col-md-10">
												<div class="coisinha" style="padding-left:50px;padding-right:10px; padding-top:10px; padding-bottom:10px">
													<a href="#adativ"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Atividades</a>
													<hr>
													<a href="#adnota"><i class="fa fa-coffee" aria-hidden="true"></i> Notas</a>
									...
									<div class="bgimg-1" id="adativ">
										<div class="caption">
											<span class="border" style="background-color:transparent;font-size:25px;color: #f7f7f7;text-shadow: 2px 2px 8px #000000;"><i class="fa fa-plus fa-2x" style="color:#f7f7f7;text-shadow: 2px 2px 8px #000000;" aria-hidden="true"></i> Atividades</span>
										</div>
									</div>
													...
													<div class="well">
														<form name="cada" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
															<!-- Insere atividades -->
																		...
																		<p><button type="button submit" name="cada" class="btn btn-success pull-right" style="margin-left: 5px;"><i class="fa fa-document" aria-hidden="true"></i> acrescentar</button></p>
									...
									<div class="bgimg-1" id="adnota">
										<div class="caption">
											<span class="border" style="background-color:transparent;font-size:25px;color: #f7f7f7;text-shadow: 2px 2px 8px #000000;"><i class="fa fa-plus fa-2x" style="color:#f7f7f7;text-shadow: 2px 2px 8px #000000;" aria-hidden="true"></i> Notas</span>
										</div>
									</div>
